...
class WCMPBE_Export
{
    ...
    {
        $isUsingSeparateFields = WCX_Order::get_meta($order, "_billing_street_name") || WCX_Order::get_meta($order, "_billing_house_number");
        ...
        $shipping_country  = (string) WCX_Order::get_prop($order, "shipping_country");
        ...
        $address = [
            ...
            'email' => $connectEmail || $hasPickupLocation['isPickup'] ? $order->get_billing_email() : '',
            'phone' => $connectPhone ? $order->get_billing_phone() : '',
        ...
        $address1 = array_merge($address, $address_intl);
    }
