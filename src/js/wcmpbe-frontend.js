 ...
 *
 * @see \wcmpbe_checkout::inject_delivery_options_variables
 */

/**
 * @property {Object} wcmpbe
 * @property {String} wcmpbe.ajax_url
 *
 * @see \wcmpbe_checkout::inject_delivery_options_variables
 */
...
jQuery(($) => {
  ...
  var MyParcelFrontend = {
     ...
     * placing the order.
     *
     * @see includes/class-wcmpbe-checkout.php::save_delivery_options();
     */
    injectHiddenInput() {
